...
{
  public class GenericHandRigController : MonoBehaviour
  {
    ...
    public void CacheRests()
    {
      if (leftArmTransform != null)
      {
        _leftArmRest = leftArmTransform.localRotation;
      }

      if (rightArmTransform != null)
      {
        _rightArmRest = rightArmTransform.localRotation;
      }

      if (headTransform != null)
      {
        _headRest = headTransform.localRotation;
      }
    }
    ...
    private void ApplyRotations()
    {
      if (leftArmTransform != null)
      {
        leftArmTransform.localRotation = ApplyAxis(_leftArmRest, leftArmAxis, _thumbWeight * leftArmMaxAngle);
      }

      if (rightArmTransform != null)
      {
        rightArmTransform.localRotation = ApplyAxis(_rightArmRest, rightArmAxis, _trioWeight * rightArmMaxAngle);
      }

      if (headTransform != null)
      {
        headTransform.localRotation = ApplyAxis(_headRest, headAxis, _indexWeight * headMaxAngle);
      }
    }
